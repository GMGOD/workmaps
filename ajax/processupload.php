...
if(isset($_POST))
{
	...
	$DestinationDirectory	= realpath('./img_empresa/'); //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<tr>';
		echo '<td align="center"><img src="./img_empresa/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		echo '</tr><tr>';
		echo '<td align="center"><img src="./img_empresa/'.$NewImageName.'" alt="Resized Image"></td>';
		echo '</tr>';
		echo '</table>';
