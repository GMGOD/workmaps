	...
	//var_dump($this->bigBlockChain);
     ...
     function __readData($bl) {
      $block = $bl;
        $pos = 0;
        $data = '';
        if($block==""){//IF QUE VALIDA SI EL CAMPO ESTA VACIDO
		?>
			<form method="post" action="?p=man&sec=man_sub">
            <p align="center">ERROR EN LA IMPORTACION</p>
		<input type="submit" name="atras" value="Atras" />
		</form>
			<? }else{//DE LO CONTRARIO ME HACE ESO
        while ($block != -2)  {
		$pos = ($block + 1) * BIG_BLOCK_SIZE;
